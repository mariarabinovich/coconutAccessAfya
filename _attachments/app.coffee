...
# Run this after
  ...
  default: ->
    switch Coconut.config.local.get("mode")
      ...
      when "mobile"
        Coconut.router.navigate("search/client",true)
  ...
  clientSearch: ->
    ...
    Coconut.clientSearchView.render()
  ...
  newClient: (lastName) ->
    @userLoggedIn
      success: ->
        ...
        Coconut.questionView.model = new Question {id: unescape('Client Registration')}
        Coconut.questionView.model.fetch
          success: ->
            Coconut.questionView.render()
  ...
  startApp: ->
    ...
    Coconut.config.fetch
      success: ->
        ...
        #   #{syncButton || ''}
        #   <a href='#help'>Help</a>
        #   <span>Version<br/><span id='version'></span></span>
        #   <span><br/><span id='databaseStatus'></span></span>
