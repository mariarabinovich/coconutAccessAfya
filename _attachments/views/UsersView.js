...
UsersView = (function(_super) {
  ...
  UsersView.prototype.render = function() {
    ...
    this.$el.html("<nav class='submenu'> <a href='#manage'>Question Sets</a> <a href='#sync'>Sync</a> <a href='#configure'>Set cloud vs mobile</a> <a class='selected' href='#'>Manage users</a> <a href='#messaging'>Send message to users</a> </nav> <h2>Create/edit users</h2> <h3>Use phone number for username to enable SMS messages</h3> <form id='user'> " + (_.map(fields, function(field) {
