...
HelpView = (function(_super) {
  ...
  HelpView.prototype.render = function() {
    return this.$el.html("<label class='helpMessage' for='message'>If you are having trouble please contact your supervisor as soon as possible. You can also describe the problem in the box below and it will send a message to our support team. We'll get back to you as soon as possible.</label> <textarea class='textArea' id='message' name='message'></textarea> <div id='messageBox'></div> </div> <input type='submit' value='Send'></input>");
  };
